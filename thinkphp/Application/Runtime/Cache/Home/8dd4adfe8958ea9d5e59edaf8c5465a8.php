	...
	<center>
		...
		<table class="table table-bordered table-hover definewidth m10">
			...
			<?php if(is_array($arr)): foreach($arr as $key=>$v): ?><tr>
				...
				<td><a href="/index.php/Home/Message/savenavstatus/id/<?php echo ($v["id"]); ?>">放入回收站</a>&nbsp;&nbsp;<a href="/index.php/Home/Message/navabout/id/<?php echo ($v["id"]); ?>">详情</a></td>
...
<script>
	function pag(page){
		...
		//连接服务器
		ajax.open("get","/index.php/Home/Message/nav/page/"+page,true);
		//发送数据
		ajax.send();
		//函数回调
