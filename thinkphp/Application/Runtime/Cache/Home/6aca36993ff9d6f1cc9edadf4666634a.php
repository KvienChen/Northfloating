...
<body>
	<center>
		<marquee behavior=alternate><font size="5" style="font-family:楷体"><b>首页广告添加</b></font></marquee>
		<form action="/index.php/Home/Message/addadvertisement" method="post" enctype="multipart/form-data">
			<table border="1" cellspacing="0" cellpadding="0">
				...
				<tr>
					<th>广告标题</th>
					<td><input type="text" name="adv_title"></td>
				</tr> 
				<tr>
					<th>广告图片</th>
					<td><input type="file" name="adv_img"></td>
				</tr>
				<tr>
					<th>展示时间</th>
					<td>
						<div style="width:970px; margin:10px auto;">
    					<input class="laydate-icon" onclick="laydate()" name="adv_start"><br /><br />
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div style="width:970px; margin:10px auto;">
    					<input class="laydate-icon" onclick="laydate()" id="demo" name="adv_end"><br /><br />
						</div>
					</td>
				</tr>
				<tr>
